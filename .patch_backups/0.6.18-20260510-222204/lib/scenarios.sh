...
set_module1_defaults() {
  ...
  BIND_FORWARD_RECORDS="hq-rtr:192.168.100.1 br-rtr:192.168.255.1 hq-srv:192.168.100.2 hq-cli:192.168.200.2 br-srv:192.168.255.2 docker:172.16.1.1 web:172.16.1.1"
...
scenario_hq_srv() {
  ...
  BIND_FORWARD_RECORDS="hq-rtr:$DEFAULT_GW br-rtr:192.168.255.1 hq-srv:$(cidr_ip "$HQ_SRV_IP_CIDR") hq-cli:192.168.200.2 br-srv:192.168.255.2 docker:172.16.1.1 web:172.16.1.1"
