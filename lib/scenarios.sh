...
scenario_isp() {
  ...
  STATIC_ROUTES="192.168.100.0/28:$HQ_RTR_WAN_IP 192.168.255.0/28:$BR_RTR_WAN_IP 192.168.200.0/27:$HQ_RTR_WAN_IP"
...
scenario_hq_rtr() {
  ...
  OSPF_ENABLE="yes"
  OSPF_NETWORKS="192.168.100.0/28 192.168.200.0/27 10.0.0.0/30"
...
scenario_br_rtr() {
  ...
  GRE_ROUTES="192.168.100.0/28:10.0.0.1 192.168.200.0/27:10.0.0.1"
  OSPF_ENABLE="yes"
