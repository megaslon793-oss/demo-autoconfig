...
create_config() {
  ...
  prompt_default SSH_REMOTE_PASSWORD "Regular server user password" "P@ssw0rd"
  ...
  prompt_default SSH_ROUTER_EXTRA_PASSWORD "Regular router user password" "P@ssw0rd"
  prompt_default SSH_ROUTER_PORT "Router SSH port" "2026"
